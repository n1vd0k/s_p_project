...
const Careere = () => {
    return(
        ...
        <CAREERE/>
            ...
            <div>
            <img className="body-img2" src="./site content/car2.jpg"></img>
...
In 2008, he was named the most valuable player of the NBA. The Lakers, led by Bryant, lost the<br/> 2008 NBA Finals, but in the 2008/09 and 2009/10 seasons, Kobe led the Lakers to an NBA<br/> victory twice more. Kobe was named the most valuable player of both finals. </p>
</div>
            <div>
                <p className="txt3">At the age of 34 years 104 days, Bryant became the youngest player in the history of<br/> the league to break the 30,000 point milestone. He also became the most productive<br/> Lakers player in history.<br/><br/>
On November 29, 2015, he announced that this was the last season of his career<br/><br/>
In the game against the Utah Jazz — his last official NBA match — Bryant scored 60<br/> points, becoming the oldest player to whom this mark was submitted. Kobe also<br/> became the first in the history of the league to score so many points in a farewell<br/> match.</p>
            <img className="body-img3" src="./site content/car3.jpg"></img>
            </div>
        </div>
    );
}
